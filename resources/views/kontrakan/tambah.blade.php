...
<div class="container">
    ...
    <div class="row">
      <div class="col-sm-6 col-md-6 mx-auto  p-4">
        <h1 class="display-4 text-center text-dar">Data Kontrakan</h1>
        
        <form method="post" action="{{url('kontrakan/store')}}" enctype="multipart/form-data">
          @csrf
            <div class="form-group">
          <label for="nama">Nama Kontrakan</label>
          <input type="text" id="nama" name="nama" class="form-control" placeholder="Nama Kontrakan">
          </div>
          <div class="form-group">
          <label for="nama">Pemilik Kontrakan</label>
          <input type="text" id="id_pemilik" name="id_pemilik" class="form-control" placeholder="Pemilik Kontrakan" value="{{Auth::user()->nama}}" readonly>
          </div>
          <div class="form-group">
          <label for="nama">Harga Kontrakan</label>
          <input type="number" id="harga" name="harga" class="form-control" placeholder="Harga Kontrakan">
          </div>
          {{-- <div class="form-group">
          ...
          <div class="form-group">
          <label for="lokasi">Alamat Kontrakan</label>
          <input type="text" id="lokasi" name="lokasi" class="form-control" placeholder="Alamat Kontrakan">
          </div>
          <div class="form-group">
          ...
          <input type="text" id="aturan" name="aturan" class="form-control" placeholder="Aturan Kontrakan">
          </div>
          <div class="form-group">
          <label for="ukuran">Ukuran</label>
          <input type="text" id="ukuran" name="ukuran" class="form-control" placeholder="Ukuran Kontrakan">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label for="tipe">Jenis Kontrakan</label>
