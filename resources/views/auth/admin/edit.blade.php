...
<div class="container bootstrap snippet">
    <div class="row">
  		<div class="col-sm-10"><h1 class="head1">Profile User</h1></div>
    </div>
    <div class="row">
    	...
    	<div class="col-sm-9">  
          <div class="#">
            <div class="#" id="profile">
                <hr>
                  <form class="form" action="{{url('update/'.$user->id)}}" method="post" id="registrationForm">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                              <label for="phone"><h5 class="head2">No Hp</h5></label>
                           ...
                           <div class="col-xs-12">
                                <br>
                              	<button class="btn btn-sm btn-success" type="submit"><i class="glyphicon glyphicon-ok-sign"></i> Simpan</button>
                               	<a class="btn btn-sm" href="{{url('admin/user')}}"><i class="glyphicon glyphicon-repeat"></i> Cancel</a>
                            </div>
                      </div>
              	</form>
