...
<div class="d-flex flex-column align-items-center h-100 flex-lg-row" style="font-family: 'Poppins', sans-serif;">
    ...
    <div class="d-flex mx-auto align-items-left justify-content-left width-right-content-3-5">
      <div class="right-content-3-5">
        ...
        <h4>[ Admin ]</h4>
        <h3 class="title-text-content-3-5">Masuk untuk melanjutkan</h3>
        <p class="caption-text-content-3-5">Silahkan masuk menggunakan akun<br>
          yang sudah terdaftar</p>

        <form style="margin-top: 1.5rem;" action="{{url('auth/admin/proses/login')}}" method="post">
          @csrf
          <div style="margin-bottom: 1.75rem;">
            ...
            <div class="d-flex w-100 div-input-content-3-5">
              ...
              <input class="input-field-content-3-5" type="email" name="email" id="email" placeholder="Alamat Email" autocomplete="on" required>
            </div>
          </div>
          <div style="margin-top: 1rem;">
            <label for="" class="d-block input-label-content-3-5">Kata Sandi</label>
            <div class="d-flex w-100 div-input-content-3-5">
              <svg class="icon-content-3-5" style="margin-right: 1rem;" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <input class="input-field-content-3-5" type="password" name="password" id="password" placeholder="Kata Sandi" minlength="6" required>
              <div>
          ...
          <div class="text-right" style="margin-top: 0.75rem;">
            <a href="#" class="forgot-password-content-3-5 font-italic">Lupa kata sandi?</a>
          </div>
          <button class="btn btn-fill-content-3-5 d-block w-100" type="submit">Masuk</button>
        </form>
        {{-- <p class="text-center bottom-caption-content-3-5">Belum memiliki akun?
          <a class="green-bottom-caption-content-3-5" href="#" >Daftar</a>
        </p> --}}
      </div>
    </div>
