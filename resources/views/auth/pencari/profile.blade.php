    	...
    	<div class="col-sm-9">  
          <div class="#">
            <div class="#" id="profile">
                <hr>
                  <form class="form" action="{{url('pencari/edit/profile')}}" method="post" id="registrationForm">
                    @csrf  
                    <div class="form-group">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                              ...
                              <input type="text" class="form-control" id="alamat" placeholder="Masukkan alamat" title="masukkan alamat" value="{{$user->alamat}}">
                          </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                           <div class="col-xs-12">
                                ...
                                <a class="btn btn-sm" href="{{url('/')}}"><i class="glyphicon glyphicon-repeat"></i> Cancel</a>
                            </div>
                      </div>
              	</form>
