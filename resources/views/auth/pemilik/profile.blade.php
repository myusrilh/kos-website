    	...
    	<div class="col-sm-9">  
          <div class="#">
            <div class="#" id="profile">
                <hr>
                  <form class="form" action="{{url('pemilik/edit/profile')}}" method="post" id="registrationForm">
                    @csrf  
                      ...
                      <div class="form-group">
                           <div class="col-xs-12">
                                <br>
                                  ...
                                  <a class="btn btn-sm" href="{{url('pemilik/home')}}"><i class="glyphicon glyphicon-repeat"></i> Cancel</a>
                            </div>
                      </div>
              	</form>
